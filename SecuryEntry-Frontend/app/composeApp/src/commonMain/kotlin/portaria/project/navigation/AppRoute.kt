...
sealed class AppRoute : NavKey {
    ...
    @Serializable data object ReservasVagasLista : AppRoute()
    @Serializable data class ReservasVagasForm(val id: String = "", val aptId: String = "") : AppRoute()

    @Serializable data object OcorrenciasLista : AppRoute()
    @Serializable data class OcorrenciasForm(val id: String = "") : AppRoute()
