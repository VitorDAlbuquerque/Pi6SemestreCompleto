 ...
 *   CT01 — Entrada automática permitida                          [RN01, RN03]
 *   CT02 — Liberação manual (veículo não cadastrado, usuário sim) [RN03]
 *   CT03 — Acesso negado (placa não cadastrada)                  [RN01]
 *   CT04 — Entrada duplicada bloqueada (status já ENTROU)        [RN03]
 *   CT05 — LPR offline → liberação manual pelo porteiro          [RN01, RN03]
 *   CT06 — Prestador no limite inferior do horário (08:00 → permitido) [RN02]
 *   CT07 — Prestador após o limite superior do horário (18:01 → negado) [RN02]
 * =============================================================================
 */
